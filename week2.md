...
이번 한 주 동안 저는 GPT를 활용해 네컷 만화를 제작하는 퀘스트를 실천했습니다.
주제는 ‘수면 부족’이었고, 늦은 시간까지 미션을 하며 커피로 버티다가 결국 아침을 맞이하는 모습을 표현했습니다.


* AI와 창작의 결합 가능성 : GPT를 통해 아이디어를 구체화하고 장면을 시각화하는 과정이 매우 빠르고 직관적이었습니다.
* 창작 효율성 향상 : 혼자서 구상부터 제작까지 하는 것보다 AI를 활용하니 작업 시간이 단축되고, 더 다양한 버전을 시험할 수 있었습니다.
* 아쉬운 점 : 표정이나 세부 상황을 완벽하게 원하는 대로 표현하려면 프롬프트 조정과 반복 시도가 필수였습니다.
